...
def remove_dataset(name=None, id=None):  # noqa: E501
    ...
    """
    backend = flask.globals.current_app.backend
    return serialize_response(backend.remove_dataset(id, name))


def get_datasets(name=None, id=None):  # noqa: E501
    ...
    """
    backend = flask.globals.current_app.backend
    return serialize_datasets(backend.get_datasets(id, name))
